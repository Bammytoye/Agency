            ...
            >
                <div>
                    ...
                    <div className='flex pl-3 rounded-lg border border-gray-300 dark:border-gray-600'>
                        ...
                        <input name="name" type="text" placeholder='Enter your name' className='w-full bg-transparent p-3 text-sm outline-none' required />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className='flex pl-3 rounded-lg border border-gray-300 dark:border-gray-600'>
                        ...
                        <input name="email" type="email" placeholder='Enter your email' className='w-full bg-transparent p-3 text-sm outline-none' required />
                    </div>
                </div>
                ...
                <div className='sm:col-span-2'>
                    ...
                    <textarea rows={8} placeholder="Enter your message"
                        ...
                        className='w-full p-3 text-sm outline-none rounded-lg bg-transparent border border-gray-300 dark:border-gray-600'
                    />
                </div>
