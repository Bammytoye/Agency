    ...
    return (
        <div id='hero' 
            ...
            <div className='relative'>
                <img src={assets.hero_img} alt="heroImage" className='w-full max-w-6xl'/>
                <img src={assets.bgImage1} alt="heroImageBlur" className='absolute -top-80 -right-40 sm:-top-100 sm:-right-70 -z-10 dark:hidden'/>
            </div>
        </div>
    )
}
